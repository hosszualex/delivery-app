...
object FakeConstants {
    val mockApiResponse = arrayListOf<GetOrdersResponse>(
    ...
    val mockRoomResponse = listOf<RoomDeliveryOrder>(
        RoomDeliveryOrder(1, "Roses1", 14.4f, "Mihai1", "address 1", "url_image 1", "NEW"),
        RoomDeliveryOrder(2, "Roses2", 14.5f, "Mihai2", "address 2", "url_image 2", "PENDING"),
        RoomDeliveryOrder(3, "Roses3", 14.6f, "Mihai3", "address 3", "url_image 3", "NEW")
    )
